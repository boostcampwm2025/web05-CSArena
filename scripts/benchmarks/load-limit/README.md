...
| 환경 | compose 파일 | 비고 |
|---|---|---|
| 호스트 무제한 | `docker-compose.unlimited.yml` | "무제한 환경" 표기 금지 — "호스트(예: M3 Pro 18GB) 자원 제한 없음" |
...
| "1000 룸 안정 운영" | "M3 Pro 18GB · 단일 노드 / cpus:1 환경에서 200 룸까지 P99 < 150ms" |
| "무제한 환경 = 알고리즘 한계" | "호스트(M3 Pro 18GB) 자원 제한 없음 — 호스트가 사실상 캡" |
